package site.yourdiary.anno.required.test;
...
import site.yourdiary.anno.required.bean.EmployeeService;
...
//        context = new AnnotationConfigApplicationContext(EmployeeServiceConfig.class);
        context = new ClassPathXmlApplicationContext("site/yourdiary/anno/anno/required/spring-config.xml");
    }
